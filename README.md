...
*XP is vanilla Minecraft XP (used for enchanting). Higher Smithing level = +5% bonus per level to both XP and money! Rewards displayed in action bar for instant visibility.*
